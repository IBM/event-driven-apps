...
public class ContainerService {
	...
	public List<ContainerOrder> assignContainerToOrder(Order order) {
		...
		LOG.info("pickup city from order: "+order.getPickupAddress().getCity());
		LOG.info("city DAO: "+this.cityDAO.toString());
		if (city == null){
		...
		for (ContainerEntity ce : containerDAO.getAllContainers(city)) {	
			LOG.info("Container entity found: "+ce.toString());			
    ...
    public ContainerEntity createContainer(Container container) {
		LOG.info("Creating a new container from: " + container.toString() + " and ID: " + container.getContainerID());
	...
	public void deleteAllContainers() {
		LOG.info("Deleting all containers");
